...
path_to_avo <- terra::sources(avocado_sp)
...
```{r message=FALSE}
risk_indexes <- msean(avocado_sp, global = FALSE, hd_threshold = 0.00001, link_threshold = 0.00001)
```
...
```{r final}
final <- msean(avocado_sp, link_threshold = 0.000001, hd_threshold = 0.000025)
