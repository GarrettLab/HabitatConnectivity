...
## 1.0 Introduction
##
# This R script analysis the invasion and dispersal risk of pest and disease based on the density
# of global cropland and the distance among them.
...
gamma2<-1                                        ###
crop<-'avocado'                                  ###
cutoff<-9.943357e-07  #cropland density cutoff        ###
cutoffadja <- 0 # cutoff of adjancecy matrix     ###
#----------------------------------------------------------
#----------------------------------------------------------
#----------------------------------------------------------
## Read in a .tif file and get data.frame lon/ lat /cropland density
##plantain_HarvestedAreaFraction

cropharvest <- raster("avocado_HarvestedAreaFraction.tif")
#cropharvestB <- raster("banana_HarvestedAreaFraction.tif")
#cropharvest <- sum(cropharvestA, cropharvestB)
#cropharvestMapSpam <- raster("") # MapSpam data need to convert unit in Hectar into harvested area fraction by deviding 10000
